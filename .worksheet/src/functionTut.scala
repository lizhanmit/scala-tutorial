object functionTut {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(83); 
  ...
  def hello2(name: String) = {
  	s"Hello, ${name}"
  };System.out.println("""hello2: (name: String)String""");$skip(151); 
  ...
  def getSum(args: Int*): Int = {
  	...
  	sum
  };System.out.println("""getSum: (args: Int*)Int""");$skip(38); 
  println("Get sum " + getSum(1,2,3));$skip(96); 
  ...
  greeting()("LZ");System.out.println("""res1: String = """ + $show(res$1));$skip(63); val res$2 = 
  ...
  add(1, 2);System.out.println("""res3: Int = """ + $show(res$3));$skip(72); 
