object if_and_for {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(52); 
  ...
  result_for;System.out.println("""res0: List[String] = """ + $show(res$0));$skip(134); 
