object collectionTut {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(54); val res$0 = 
   ...
   */
	...
	1 until 10;System.out.println("""res3: scala.collection.immutable.Range = """ + $show(res$3));$skip(57); 
  ...
  for (i <- 0 to 2) println(intArr(i));$skip(89); 
  ...
  favNums.deep.mkString(", ");System.out.println("""res9: String = """ + $show(res$9));$skip(87); 
   ...
   * ArrayBuffer
   */
	import scala.collection.mutable.ArrayBuffer;System.out.println("""myMatrix  : Array[Array[Int]] = """ + $show(myMatrix ));$skip(114); 
  ...
  tuple1.toString();System.out.println("""res13: String = """ + $show(res$13));$skip(369); 
  ...
  def sumSq(inputParam: List[Double]): (Int, Double, Double) =
  		inputParam.foldLeft((0, 0d, 0d))((t, v) => (t._1 + 1, t._2 + v, t._3 + v * v));System.out.println("""sumSq: (inputParam: List[Double])(Int, Double, Double)""");$skip(35); val res$14 = 
  		
  	sumSq(List(1.0, 2.0, 3.0));System.out.println("""res14: (Int, Double, Double) = """ + $show(res$14));$skip(47); 
  ...
  };System.out.println("""walkthru: (l: List[Int])String""");$skip(15); val res$16 = 

  walkthru(b);System.out.println("""res16: String = """ + $show(res$16));$skip(62); val res$17 = 

  // get odd numbers in the list
  a.filter(x => x % 2 == 1);System.out.println("""res17: List[Int] = """ + $show(res$17));$skip(101); val res$18 = 
  ...
  "99 Red Balloons".toList.takeWhile(x => x != 'B');System.out.println("""res19: List[Char] = """ + $show(res$19));$skip(31); 
  ...
  c.map(_.toUpperCase);System.out.println("""res21: List[String] = """ + $show(res$21));$skip(36); val res$22 =  // short version

  a.filter(_ % 2 == 1).map(_ + 10);System.out.println("""res22: List[Int] = """ + $show(res$22));$skip(22); 
  ...
  q.flatMap(_.filter(_ % 2 == 1));System.out.println("""res24: List[Int] = """ + $show(res$24));$skip(23); val res$25 = 
  ...
  // with start value: 1
  a.foldLeft(1)(_ * _);System.out.println("""res27: Int = """ + $show(res$27));$skip(53); 
  ...
  m -- List(1, 2);System.out.println("""res35: scala.collection.immutable.Map[Int,String] = """ + $show(res$35));$skip(83); 
  ...
  /*
	...
	stream.tail;System.out.println("""res37: scala.collection.immutable.Stream[Int] = """ + $show(res$37));$skip(193); 
  ...
  def quickSort(a: List[Int]): List[Int] =
    if (a.length < 2) a
    else quickSort(a.filter(_ < a.head)) ++ a.filter(_ == a.head) ++ quickSort(a.filter(_ > a.head));System.out.println("""quickSort: (a: List[Int])List[Int]""");$skip(49); val res$38 = 
